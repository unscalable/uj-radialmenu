    ...
    ["police"] = {
        {
            ...
            icon = '#raygun',
            type = 'client',
            event = 'keep-gunrack:client:open_gunrack_menue',
            shouldClose = true
        }, {
